...
const LoginPopUp = ({setshowSignIn}) => {
  ...
  <div className="login-popup md:mt-10">
    ...
    <div></div>
        <div>{user==="Sign Up"?<h1 className='text-2xl font-bold text-orange-600 mb-2'>Sign Up</h1>:<h1 className='text-2xl font-bold text-orange-600 mb-2'>Login</h1>}</div>
      <div onClick={()=>setshowSignIn(false)} className="cursor-pointer ">
